...
public partial class Db21027Context : DbContext
{
    public Db21027Context()
    {
    }

    public Db21027Context(DbContextOptions<Db21027Context> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=db21027.public.databaseasp.net; Database=db21027; User Id=db21027; Password=3b@LmY5%!oE2; Encrypt=True; TrustServerCertificate=True; MultipleActiveResultSets=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Accommodation>(entity =>
        {
            entity.HasKey(e => e.AccommodationId).HasName("PK__Accommod__004EC325C1886149");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Accommod__3213E83FA3734C79");
        ...
        {
            entity.HasKey(e => e.DetailId).HasName("PK__Accommod__38E9A22486722DBC");

            entity.HasIndex(e => e.AccommodationId, "UQ__Accommod__004EC324DD38ED6E").IsUnique();
        ...
        {
            entity.HasKey(e => e.ImageId).HasName("PK__Accommod__DC9AC955EC9D1685");
        ...
        {
            entity.HasKey(e => e.TypeId).HasName("PK__Accommod__2C000598FD604CA2");

            entity.ToTable("AccommodationType");

            entity.HasIndex(e => e.TypeName, "UQ__Accommod__543C4FD930BFD51A").IsUnique();
        ...
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__46A222CDE6200D7C");

            entity.ToTable("Account");

            entity.HasIndex(e => e.Email, "UQ__Account__AB6E61642F7AD742").IsUnique();
        ...
        {
            entity.HasKey(e => e.AmenityId).HasName("PK__Amenitie__E908452D83AA39AB");
        ...
        {
            entity.HasKey(e => e.ConversationId).HasName("PK__Conversa__311E7E9ADD12EFF4");
        ...
        {
            entity.HasKey(e => e.FavoriteId).HasName("PK__Favorite__46ACF4CB9E2654DF");
        ...
        {
            entity.HasKey(e => e.MessageId).HasName("PK__Message__0BBF6EE666C825F5");
        ...
        {
            entity.HasKey(e => e.PricingId).HasName("PK__PackageP__A25A9FB7E298F4E5");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__Payment__ED1FC9EAA383E67D");
        ...
        {
            entity.HasKey(e => e.MethodId).HasName("PK__PaymentM__747727B6C6B4D8CB");
        ...
        {
            entity.HasKey(e => e.PostId).HasName("PK__Post__3ED7876689AE8B28");
        ...
        {
            entity.HasKey(e => e.ApprovalId).HasName("PK__PostAppr__C94AE61AA9F32739");
        ...
        {
            entity.HasKey(e => e.CommentId).HasName("PK__PostComm__E79576870DE66A78");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__PostPack__3213E83FA2B3140F");
        ...
        {
            entity.HasKey(e => e.PackageTypeId).HasName("PK__PostPack__DFBEE40ABB7B311F");
        ...
        {
            entity.HasKey(e => e.PromoId).HasName("PK__PromoCod__84EB4CA54D37DD78");

            entity.ToTable("PromoCode");

            entity.HasIndex(e => e.Code, "UQ__PromoCod__357D4CF914352C16").IsUnique();
        ...
        {
            entity.HasKey(e => e.PromoUsageId).HasName("PK__PromoUsa__60E8C63869866513");
        ...
        {
            entity.HasKey(e => e.TemplateId).HasName("PK__QuickRep__BE44E079290FBCDF");
        ...
        {
            entity.HasKey(e => e.TimeUnitId).HasName("PK__TimeUnit__8304AF47ACABDA65");
        ...
        {
            entity.HasKey(e => e.ProfileId).HasName("PK__UserProf__AEBB701F10DD32D2");

            entity.ToTable("UserProfile");

            entity.HasIndex(e => e.AccountId, "UQ__UserProf__46A222CCD3ED30E0").IsUnique();
