...
using RentNest.Service.Services.MailService;
...
namespace RentNest.Web.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(IPostService postService, IMailService mailService, IConfiguration configuration)
        {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                bool hasSearched = TempData["HasSearched"] is bool hs && hs;
            ...
            {
                throw new Exception("Loi khi xu lý trang chu", ex);
            }
        }
        ...
        public async Task<IActionResult> Contact(ContactFormViewModel model)
        {
            ...
            {
                To = model.Email,
                Subject = "Cảm ơn bạn đã liên hệ với BlueDreamHouse - RentNest",
                Body = $@"
            <div style='font-family: Arial, sans-serif; color: #333; line-height: 1.6;'>
                ...
                <p>Nếu bạn cần hỗ trợ gấp hoặc có thắc mắc gì, đừng ngần ngại trả lời gmail này hoặc gọi cho chúng tôi nhé.</p>
